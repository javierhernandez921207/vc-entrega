 ...
 */
final class Version20200312182402 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE producto ADD cant_min INT DEFAULT NULL, CHANGE img img VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pedido CHANGE trabajador_id trabajador_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE producto DROP cant_min, CHANGE img img VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
