 ...
 */
final class Version20200302160028 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pedido ADD total DOUBLE PRECISION NOT NULL');
        $this->addSql('ALTER TABLE producto CHANGE img img VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE producto_pedido ADD nombre VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE producto_pedido DROP nombre');
