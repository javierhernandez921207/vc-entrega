 ...
 */
final class Version20200312175711 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE producto ADD costo DOUBLE PRECISION NOT NULL, CHANGE img img VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pedido CHANGE trabajador_id trabajador_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE producto DROP costo, CHANGE img img VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
