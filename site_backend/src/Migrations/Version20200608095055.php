 ...
 */
final class Version20200608095055 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pedido ADD pago_viaje DOUBLE PRECISION DEFAULT NULL, CHANGE trabajador_id trabajador_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pedido DROP pago_viaje, CHANGE trabajador_id trabajador_id INT DEFAULT NULL');
